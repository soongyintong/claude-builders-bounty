# AGENTS.md — claude-builders-bounty-2

> 墨子 Harness · 自动生成于 2026-06-22

---

## 项目说明

- **项目名称**: claude-builders-bounty-2
- **仓库地址**: https://github.com/claude-builders-bounty/claude-builders-bounty.git
- **技术栈**: Node.js
- **目标**: 为 Next.js 15 App Router + SQLite SaaS 项目创建可直接使用的、带明确理由的 CLAUDE.md 模板
- **Bounty链接**: https://github.com/claude-builders-bounty/claude-builders-bounty/issues/2
